...
using FSH.Modules.Products.Contracts.Application.Features.Queries.SearchIssues;
...
namespace FSH.Modules.Products.Application.Features.Queries.SearchIssues;
